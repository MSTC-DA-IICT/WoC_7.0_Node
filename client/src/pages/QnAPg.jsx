        ...
        <div className='m-4'>
            ...
            {what === "qna" && (
                <>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 my-6 mx-2">
                        {questions.map((question) => (
                            <div
                                ...
                                key={question._id}
                                onClick={() => handleQuestionClick(question._id, question.file, question.text)}
                            >
                                <figure>
                                    <img
                    ...
                    >
                        <Link to="/qna_upload" className="text-xl">Add</Link>
                    </div>
                </>
            )}
            ...
            {what === "chat" && (
                <>
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-4">
                        {answers.map((answer) => (
                            <div className={authUser._id === answer.senderId ? "chat chat-start" : "chat chat-end"} key={answer._id}>
